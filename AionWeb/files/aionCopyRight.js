...
+'			<a style="margin-left: -5px;" href="http://www.shandagames.com/" target="_blank" class="SDGCOPYRIGHT-logo1">盛大游戏</a>'
//+'			<a href="http://1000y.sdo.com/web2/index/index.asp" target="_blank">'
+'				<img src="http://static.sdg-china.com/copyright/pic/aion/LOGO.png" style="float:left;margin-top: 15px;" alt="合作方Logo">'
//+'			</a>'
+'		</div>'
//版权主体信息
...
//每个项目组自己的版权号
+'			<p>'
+'				<span class="SDGCOPYRIGHT-pr3">新出审字[2012]949号</span>'
+'				文网进字[2012]026号'
+'			</p>'
